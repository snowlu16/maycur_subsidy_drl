...
## 七、 完整真实模板索引（共 13 个官方 + 3 个参考模板）

### 半天（12:00 分界）系列
| 文件 | 场景 | 关键特性 |
| :--- | :--- | :--- |
| [real_1.1_仅参与人_半天_每人每天一条](file:///examples/real_1.1_仅参与人_半天_每人每天一条.drl) | 仅参与人 / 不汇总 | `isDayHalveOrOverlap` |
| [real_1.4_含报销人和参与人_半天_每人每天一条](file:///examples/real_1.4_含报销人和参与人_半天_每人每天一条.drl) | **最通用模板** / 报销人+参与人各自每天一条 | 双 rule，salience 20+10 |
...
| [real_2.2_不含报销人_全天_行程汇总](file:///examples/real_2.2_不含报销人_全天_行程汇总.drl) | 仅参与人 / 全天 / 行程汇总 | 简洁版 `isDayOverlap` |
...
| [real_2.8_含报销人和参与人_全天_按天汇总](file:///examples/real_2.8_含报销人和参与人_全天_按天汇总.drl) | 全天 / 按天所有人合并一条 | 每日循环 insert |
| [real_2.10_含报销人和参与人_全天_行程选项扣减](file:///examples/real_2.10_含报销人和参与人_全天_行程选项扣减.drl) | 行程内选项触发扣减 | `customFormValues` 比对 |
...
1. **需求分析**：
   ...
   - 是否有多套标准（国内/国外 / 不同职级）？
   - 查阅：[调研框架](file:///references/requirements_framework.md) | [API 手册](file:///references/api_reference.md) | [字段字典](file:///references/openapi_models.md)
...
4. **上传与测试**：
   ...
   - 提交测试报销单，在日志中查看 `logger.info` 输出确认金额计算正确
